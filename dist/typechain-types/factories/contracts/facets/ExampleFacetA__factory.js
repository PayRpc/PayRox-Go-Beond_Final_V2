...
exports.ExampleFacetA__factory = void 0;
...
class ExampleFacetA__factory extends ethers_1.ContractFactory {
    ...
    static linkBytecode(linkLibraryAddresses) {
        ...
        linkedBytecode = linkedBytecode.replace(new RegExp("__\\$6853d4dd8c8d70faf0c6e9a986736f2751\\$__", "g"), linkLibraryAddresses["contracts/utils/GasOptimizationUtils.sol:GasOptimizationUtils"]
            .replace(/^0x/, "")
            .toLowerCase());
...
exports.ExampleFacetA__factory = ExampleFacetA__factory;
