...
export declare class ExampleFacetA__factory extends ContractFactory {
    ...
    static readonly abi: readonly [{
        ...
        readonly name: "BatchExecutedOptimized";
        readonly type: "event";
    }, {
        readonly anonymous: false;
        readonly inputs: readonly [{
        ...
        readonly name: "FacetAExecutedHash";
        readonly type: "event";
    }, {
        readonly inputs: readonly [{
            readonly internalType: "string[]";
        ...
        readonly name: "storeData";
        readonly outputs: readonly [];
        readonly stateMutability: "nonpayable";
        readonly type: "function";
    }, {
        readonly inputs: readonly [];
        readonly name: "totalExecutions";
        readonly outputs: readonly [{
            readonly internalType: "uint256";
            readonly name: "";
            readonly type: "uint256";
    ...
    static connect(address: string, runner?: ContractRunner | null): ExampleFacetA;
}
