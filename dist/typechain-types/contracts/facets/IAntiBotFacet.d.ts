...
export interface IAntiBotFacetInterface extends Interface {
    getFunction(nameOrSignature: 'GOVERNANCE_ROLE' | 'MONITOR_ROLE' | 'addTrusted' | 'ensureBuybackAllowed' | 'isTrusted' | 'removeTrusted' | 'reportMarketMove' | 'resetCircuitBreaker' | 'setBuybackPaused' | 'setEnabled' | 'setThresholds' | 'setThrottleBlocks' | 'validateTransaction'): FunctionFragment;
