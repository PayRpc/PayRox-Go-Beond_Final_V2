...
export interface PayRoxPaymentsFacetInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "createPayment", values: [AddressLike, BigNumberish, BytesLike]): string;
...
export interface PayRoxPaymentsFacet extends BaseContract {
    ...
    getFunction(nameOrSignature: "createPayment"): TypedContractMethod<[
        to: AddressLike,
        amount: BigNumberish,
        ref: BytesLike
    ], [
    ...
    getFunction(nameOrSignature: "settlePayment"): TypedContractMethod<[ref: BytesLike], [void], "nonpayable">;
    filters: {};
}
