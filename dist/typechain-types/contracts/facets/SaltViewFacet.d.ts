...
export interface SaltViewFacetInterface extends Interface {
    getFunction(nameOrSignature: "eip2470" | "factorySalt" | "hashInitCode" | "predictCreate2" | "universalSalt"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "predictCreate2", values: [AddressLike, BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "universalSalt", values: [AddressLike, string, BigNumberish, string]): string;
...
export interface SaltViewFacet extends BaseContract {
    ...
    getFunction(nameOrSignature: "factorySalt"): TypedContractMethod<[version: string], [string], "view">;
    getFunction(nameOrSignature: "hashInitCode"): TypedContractMethod<[initCode: BytesLike], [string], "view">;
    getFunction(nameOrSignature: "predictCreate2"): TypedContractMethod<[
        deployer: AddressLike,
        salt: BytesLike,
        initCodeHash: BytesLike
    ], [
    ...
    getFunction(nameOrSignature: "universalSalt"): TypedContractMethod<[
        deployer: AddressLike,
        content: string,
        crossNonce: BigNumberish,
        version: string
