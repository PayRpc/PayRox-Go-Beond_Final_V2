...
export interface PayRoxAdminFacetInterface extends Interface {
    ...
    encodeFunctionData(functionFragment: "initPayRox", values: [AddressLike, AddressLike, BigNumberish, BytesLike]): string;
...
export interface PayRoxAdminFacet extends BaseContract {
    ...
    getFunction(nameOrSignature: "initPayRox"): TypedContractMethod<[
        owner: AddressLike,
        treasury: AddressLike,
        feeBps: BigNumberish,
        expectedStructHash: BytesLike
    ...
    getFunction(nameOrSignature: "setFee"): TypedContractMethod<[feeBps: BigNumberish], [void], "nonpayable">;
