...
export interface DiamondInterface extends Interface {
    getFunction(nameOrSignature: "addFacet" | "facetAddress" | "facetAddresses" | "facetFunctionSelectors" | "facets" | "owner"): FunctionFragment;
    encodeFunctionData(functionFragment: "addFacet", values: [AddressLike, BytesLike[]]): string;
...
export interface Diamond extends BaseContract {
    ...
    getFunction(nameOrSignature: "addFacet"): TypedContractMethod<[
        _facet: AddressLike,
        _selectors: BytesLike[]
    ], [
        void
