...
export interface EpochManagerInterface extends Interface {
    getFunction(nameOrSignature: "MAX_EPOCH_JUMP" | "advanceEpoch" | "getCurrentEpoch" | "listener" | "owner" | "registerListener" | "setEpoch"): FunctionFragment;
...
export declare namespace EpochAdvancedEvent {
    type InputTuple = [oldEpoch: BigNumberish, newEpoch: BigNumberish];
    type OutputTuple = [oldEpoch: bigint, newEpoch: bigint];
...
export interface EpochManager extends BaseContract {
    ...
    getFunction(nameOrSignature: "registerListener"): TypedContractMethod<[l: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "setEpoch"): TypedContractMethod<[newEpoch: BigNumberish], [void], "nonpayable">;
    getEvent(key: "EpochAdvanced"): TypedContractEvent<EpochAdvancedEvent.InputTuple, EpochAdvancedEvent.OutputTuple, EpochAdvancedEvent.OutputObject>;
    filters: {
        "EpochAdvanced(uint64,uint64)": TypedContractEvent<EpochAdvancedEvent.InputTuple, EpochAdvancedEvent.OutputTuple, EpochAdvancedEvent.OutputObject>;
        EpochAdvanced: TypedContractEvent<EpochAdvancedEvent.InputTuple, EpochAdvancedEvent.OutputTuple, EpochAdvancedEvent.OutputObject>;
    };
}
