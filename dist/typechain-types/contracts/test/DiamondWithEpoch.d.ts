...
export declare namespace DiamondWithEpoch {
    type CommitmentEntryStruct = {
        facetAddress: AddressLike;
    };
    type CommitmentEntryStructOutput = [facetAddress: string] & {
        facetAddress: string;
    };
    type CommitmentStruct = {
        facetAddress: AddressLike;
    };
    type CommitmentStructOutput = [facetAddress: string] & {
        facetAddress: string;
    };
    type RoutingHistoryEntryStruct = {
        facetAddress: AddressLike;
        epoch: BigNumberish;
    };
    type RoutingHistoryEntryStructOutput = [
        facetAddress: string,
        epoch: bigint
    ] & {
        facetAddress: string;
...
export interface DiamondWithEpochInterface extends Interface {
    getFunction(nameOrSignature: "MAX_EPOCH_JUMP" | "commitFacetUpdate" | "commitmentHistory" | "commitments" | "dispatcher" | "emergencyEpochReset" | "emergencyPause" | "epochManager" | "facetAddress" | "facetAddresses" | "facetFunctionSelectors" | "facets" | "getCommitmentHistory" | "getEpochCommitment" | "getRoutingHistory" | "onEpochAdvanced" | "paused" | "validateEpochConsistency"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "commitFacetUpdate", values: [AddressLike, BytesLike[], BigNumberish]): string;
    encodeFunctionData(functionFragment: "commitmentHistory", values: [BigNumberish, BytesLike, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "getCommitmentHistory", values: [BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "getEpochCommitment", values: [BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "getRoutingHistory", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "onEpochAdvanced", values: [BigNumberish, BigNumberish]): string;
...
export declare namespace CommitmentOverwrittenEvent {
    type InputTuple = [
        epoch: BigNumberish,
        selector: BytesLike,
...
export interface DiamondWithEpoch extends BaseContract {
    ...
    getFunction(nameOrSignature: "commitFacetUpdate"): TypedContractMethod<[
        facet: AddressLike,
        selectors: BytesLike[],
        epoch: BigNumberish
    ], [
    ...
    getFunction(nameOrSignature: "commitmentHistory"): TypedContractMethod<[
        arg0: BigNumberish,
        arg1: BytesLike,
        arg2: BigNumberish
    ], [
    ...
    getFunction(nameOrSignature: "emergencyEpochReset"): TypedContractMethod<[], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "getCommitmentHistory"): TypedContractMethod<[
        epoch: BigNumberish,
        selector: BytesLike
    ], [
        DiamondWithEpoch.CommitmentEntryStructOutput[]
    ], "view">;
    getFunction(nameOrSignature: "getEpochCommitment"): TypedContractMethod<[
        epoch: BigNumberish,
        selector: BytesLike
    ], [
        DiamondWithEpoch.CommitmentStructOutput
    ], "view">;
    getFunction(nameOrSignature: "getRoutingHistory"): TypedContractMethod<[
        selector: BytesLike
    ], [
        DiamondWithEpoch.RoutingHistoryEntryStructOutput[]
    ], "view">;
    getFunction(nameOrSignature: "onEpochAdvanced"): TypedContractMethod<[
        arg0: BigNumberish,
        newEpoch: BigNumberish
    ], [
        void
    ...
    getFunction(nameOrSignature: "validateEpochConsistency"): TypedContractMethod<[], [boolean], "view">;
    getEvent(key: "CommitmentOverwritten"): TypedContractEvent<CommitmentOverwrittenEvent.InputTuple, CommitmentOverwrittenEvent.OutputTuple, CommitmentOverwrittenEvent.OutputObject>;
    filters: {
        "CommitmentOverwritten(uint64,bytes4,address,address)": TypedContractEvent<CommitmentOverwrittenEvent.InputTuple, CommitmentOverwrittenEvent.OutputTuple, CommitmentOverwrittenEvent.OutputObject>;
        CommitmentOverwritten: TypedContractEvent<CommitmentOverwrittenEvent.InputTuple, CommitmentOverwrittenEvent.OutputTuple, CommitmentOverwrittenEvent.OutputObject>;
    };
}
