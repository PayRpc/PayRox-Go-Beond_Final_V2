...
export interface AuditRegistryInterface extends Interface {
    getFunction(nameOrSignature: "AUDITOR_ROLE" | "AUDIT_ADMIN_ROLE" | "MAX_AUDIT_VALIDITY" | "MIN_AUDIT_VALIDITY" | "auditExpiration" | "auditValidityPeriod" | "auditedManifests" | "auditorStats" | "audits" | "certifiedAuditors" | "certifyAuditor" | "getAuditCount" | "getAuditStatus" | "getAuditedManifests" | "getAuditorInfo" | "markExpiredAudits" | "requiresAudit" | "revokeAuditor" | "submitAudit" | "updateAuditValidityPeriod"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "AuditCompleted" | "AuditExpired" | "AuditSubmitted" | "AuditValidityUpdated" | "AuditorCertified" | "AuditorRevoked"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "getAuditedManifests", values: [BigNumberish, BigNumberish]): string;
...
export declare namespace AuditExpiredEvent {
    type InputTuple = [manifestHash: BytesLike, auditor: AddressLike];
    type OutputTuple = [manifestHash: string, auditor: string];
    interface OutputObject {
        manifestHash: string;
        auditor: string;
    }
...
export declare namespace AuditSubmittedEvent {
    type InputTuple = [
        manifestHash: BytesLike,
        auditor: AddressLike,
        passed: boolean,
...
export declare namespace AuditValidityUpdatedEvent {
    type InputTuple = [oldPeriod: BigNumberish, newPeriod: BigNumberish];
    type OutputTuple = [oldPeriod: bigint, newPeriod: bigint];
    interface OutputObject {
        oldPeriod: bigint;
        newPeriod: bigint;
    }
...
export declare namespace AuditorCertifiedEvent {
    type InputTuple = [auditor: AddressLike, certifier: AddressLike];
    type OutputTuple = [auditor: string, certifier: string];
    interface OutputObject {
        auditor: string;
        certifier: string;
    }
...
export declare namespace AuditorRevokedEvent {
    type InputTuple = [auditor: AddressLike, revoker: AddressLike];
    type OutputTuple = [auditor: string, revoker: string];
    interface OutputObject {
        auditor: string;
        revoker: string;
    }
...
export interface AuditRegistry extends BaseContract {
    ...
    getAuditStatus: TypedContractMethod<[
        ...
        [
            boolean,
            ManifestTypes.AuditInfoStructOutput
        ] & {
            isValid: boolean;
    ...
    getFunction(nameOrSignature: "auditExpiration"): TypedContractMethod<[arg0: BytesLike], [bigint], "view">;
    getFunction(nameOrSignature: "auditValidityPeriod"): TypedContractMethod<[], [bigint], "view">;
    getFunction(nameOrSignature: "auditedManifests"): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
    getFunction(nameOrSignature: "auditorStats"): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "certifiedAuditors"): TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
    getFunction(nameOrSignature: "certifyAuditor"): TypedContractMethod<[auditor: AddressLike], [void], "nonpayable">;
    ...
    getFunction(nameOrSignature: "getAuditedManifests"): TypedContractMethod<[
        offset: BigNumberish,
        limit: BigNumberish
    ], [
        [string[], bigint] & {
    ...
    getFunction(nameOrSignature: "getAuditorInfo"): TypedContractMethod<[
        auditor: AddressLike
    ], [
        [boolean, bigint] & {
            isCertified: boolean;
    ...
    getFunction(nameOrSignature: "markExpiredAudits"): TypedContractMethod<[manifestHashes: BytesLike[]], [void], "nonpayable">;
    getFunction(nameOrSignature: "requiresAudit"): TypedContractMethod<[manifestHash: BytesLike], [boolean], "view">;
    getFunction(nameOrSignature: "revokeAuditor"): TypedContractMethod<[auditor: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "submitAudit"): TypedContractMethod<[
        manifestHash: BytesLike,
        passed: boolean,
        reportUri: string
    ], [
    ...
    getFunction(nameOrSignature: "updateAuditValidityPeriod"): TypedContractMethod<[newPeriod: BigNumberish], [void], "nonpayable">;
    ...
    getEvent(key: "AuditExpired"): TypedContractEvent<AuditExpiredEvent.InputTuple, AuditExpiredEvent.OutputTuple, AuditExpiredEvent.OutputObject>;
    getEvent(key: "AuditSubmitted"): TypedContractEvent<AuditSubmittedEvent.InputTuple, AuditSubmittedEvent.OutputTuple, AuditSubmittedEvent.OutputObject>;
    getEvent(key: "AuditValidityUpdated"): TypedContractEvent<AuditValidityUpdatedEvent.InputTuple, AuditValidityUpdatedEvent.OutputTuple, AuditValidityUpdatedEvent.OutputObject>;
    getEvent(key: "AuditorCertified"): TypedContractEvent<AuditorCertifiedEvent.InputTuple, AuditorCertifiedEvent.OutputTuple, AuditorCertifiedEvent.OutputObject>;
    getEvent(key: "AuditorRevoked"): TypedContractEvent<AuditorRevokedEvent.InputTuple, AuditorRevokedEvent.OutputTuple, AuditorRevokedEvent.OutputObject>;
    filters: {
        ...
        "AuditExpired(bytes32,address)": TypedContractEvent<AuditExpiredEvent.InputTuple, AuditExpiredEvent.OutputTuple, AuditExpiredEvent.OutputObject>;
        AuditExpired: TypedContractEvent<AuditExpiredEvent.InputTuple, AuditExpiredEvent.OutputTuple, AuditExpiredEvent.OutputObject>;
        "AuditSubmitted(bytes32,address,bool,string)": TypedContractEvent<AuditSubmittedEvent.InputTuple, AuditSubmittedEvent.OutputTuple, AuditSubmittedEvent.OutputObject>;
        AuditSubmitted: TypedContractEvent<AuditSubmittedEvent.InputTuple, AuditSubmittedEvent.OutputTuple, AuditSubmittedEvent.OutputObject>;
        "AuditValidityUpdated(uint256,uint256)": TypedContractEvent<AuditValidityUpdatedEvent.InputTuple, AuditValidityUpdatedEvent.OutputTuple, AuditValidityUpdatedEvent.OutputObject>;
        AuditValidityUpdated: TypedContractEvent<AuditValidityUpdatedEvent.InputTuple, AuditValidityUpdatedEvent.OutputTuple, AuditValidityUpdatedEvent.OutputObject>;
        "AuditorCertified(address,address)": TypedContractEvent<AuditorCertifiedEvent.InputTuple, AuditorCertifiedEvent.OutputTuple, AuditorCertifiedEvent.OutputObject>;
        AuditorCertified: TypedContractEvent<AuditorCertifiedEvent.InputTuple, AuditorCertifiedEvent.OutputTuple, AuditorCertifiedEvent.OutputObject>;
        "AuditorRevoked(address,address)": TypedContractEvent<AuditorRevokedEvent.InputTuple, AuditorRevokedEvent.OutputTuple, AuditorRevokedEvent.OutputObject>;
        AuditorRevoked: TypedContractEvent<AuditorRevokedEvent.InputTuple, AuditorRevokedEvent.OutputTuple, AuditorRevokedEvent.OutputObject>;
    };
}
