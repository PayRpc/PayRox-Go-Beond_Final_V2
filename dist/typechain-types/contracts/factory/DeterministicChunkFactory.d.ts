...
export interface DeterministicChunkFactoryInterface extends Interface {
    getFunction(nameOrSignature: "FEE_ROLE" | "MAX_CHUNK_BYTES" | "OPERATOR_ROLE" | "addAuthorizedRecipient" | "authorizedRecipients" | "baseFeeWei" | "chunkOf" | "defaultAdmin" | "deployDeterministic" | "deployDeterministicBatch" | "deploymentCount" | "emergencyWithdraw" | "exists" | "expectedDispatcherCodehash" | "expectedFactoryBytecodeHash" | "expectedManifestDispatcher" | "expectedManifestHash" | "feeRecipient" | "feesEnabled" | "getDeploymentCount" | "getDeploymentFee" | "getExpectedDispatcherCodehash" | "getExpectedFactoryBytecodeHash" | "getExpectedManifestHash" | "getManifestDispatcher" | "getUserTier" | "idempotentMode" | "isDeployed" | "isDeployedContract" | "maxSingleTransfer" | "owner" | "predict" | "predictAddress" | "predictAddressBatch" | "read" | "removeAuthorizedRecipient" | "setBaseFeeWei" | "setFeeRecipient" | "setFeesEnabled" | "setIdempotentMode" | "setMaxSingleTransfer" | "setTierFee" | "setUserTier" | "stage" | "stageBatch" | "stageMany" | "tierFees" | "transferDefaultAdmin" | "userTiers" | "validateBytecodeSize" | "verifySystemIntegrity" | "withdrawFees" | "withdrawRefund"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "AuthorizedRecipientAdded" | "AuthorizedRecipientRemoved" | "BaseFeeSet" | "BatchDeployed" | "BatchStaged" | "ChunkStaged" | "ContractDeployed" | "DefaultAdminTransferred" | "EmergencyWithdrawal" | "FeeCollectionFailed" | "FeeRecipientSet" | "FeesEnabledSet" | "FeesWithdrawn" | "IdempotentModeSet" | "TierFeeSet" | "UserTierSet"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "deployDeterministic", values: [BytesLike, BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "deployDeterministicBatch", values: [BytesLike[], BytesLike[], BytesLike[]]): string;
    ...
    encodeFunctionData(functionFragment: "getExpectedFactoryBytecodeHash", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "predictAddressBatch", values: [BytesLike[], BytesLike[]]): string;
...
export declare namespace AuthorizedRecipientAddedEvent {
    type InputTuple = [recipient: AddressLike];
    type OutputTuple = [recipient: string];
...
export declare namespace AuthorizedRecipientRemovedEvent {
    type InputTuple = [recipient: AddressLike];
    type OutputTuple = [recipient: string];
    interface OutputObject {
        recipient: string;
...
export declare namespace BaseFeeSetEvent {
    type InputTuple = [newBaseFee: BigNumberish];
    type OutputTuple = [newBaseFee: bigint];
    interface OutputObject {
        newBaseFee: bigint;
    }
    type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export declare namespace BatchDeployedEvent {
    type InputTuple = [
...
export declare namespace BatchStagedEvent {
    type InputTuple = [
...
export declare namespace ChunkStagedEvent {
    type InputTuple = [
        chunk: AddressLike,
        hash: BytesLike,
        salt: BytesLike,
...
export declare namespace DefaultAdminTransferredEvent {
...
export declare namespace FeeCollectionFailedEvent {
    type InputTuple = [collector: AddressLike, amount: BigNumberish];
    type OutputTuple = [collector: string, amount: bigint];
    interface OutputObject {
        collector: string;
        amount: bigint;
    }
...
export declare namespace FeeRecipientSetEvent {
...
export declare namespace FeesEnabledSetEvent {
...
export declare namespace FeesWithdrawnEvent {
    type InputTuple = [recipient: AddressLike, amount: BigNumberish];
    type OutputTuple = [recipient: string, amount: bigint];
    interface OutputObject {
        recipient: string;
...
export declare namespace IdempotentModeSetEvent {
    type InputTuple = [enabled: boolean];
    type OutputTuple = [enabled: boolean];
    interface OutputObject {
        enabled: boolean;
...
export declare namespace TierFeeSetEvent {
    type InputTuple = [tier: BigNumberish, fee: BigNumberish];
    type OutputTuple = [tier: bigint, fee: bigint];
    interface OutputObject {
        tier: bigint;
        fee: bigint;
    }
...
export declare namespace UserTierSetEvent {
    type InputTuple = [user: AddressLike, tier: BigNumberish];
    type OutputTuple = [user: string, tier: bigint];
    interface OutputObject {
        user: string;
        tier: bigint;
    }
...
export interface DeterministicChunkFactory extends BaseContract {
    ...
    getFunction(nameOrSignature: "addAuthorizedRecipient"): TypedContractMethod<[recipient: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "authorizedRecipients"): TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
    ...
    getFunction(nameOrSignature: "deployDeterministic"): TypedContractMethod<[
        salt: BytesLike,
        bytecode: BytesLike,
        constructorArgs: BytesLike
    ], [
    ...
    getFunction(nameOrSignature: "deployDeterministicBatch"): TypedContractMethod<[
        salts: BytesLike[],
        bytecodes: BytesLike[],
        constructorArgs: BytesLike[]
    ], [
    ...
    getFunction(nameOrSignature: "expectedDispatcherCodehash"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "expectedFactoryBytecodeHash"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "expectedManifestDispatcher"): TypedContractMethod<[], [string], "view">;
    ...
    getFunction(nameOrSignature: "getExpectedDispatcherCodehash"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "getExpectedFactoryBytecodeHash"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "getExpectedManifestHash"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "getManifestDispatcher"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "getUserTier"): TypedContractMethod<[user: AddressLike], [bigint], "view">;
    getFunction(nameOrSignature: "idempotentMode"): TypedContractMethod<[], [boolean], "view">;
    getFunction(nameOrSignature: "isDeployed"): TypedContractMethod<[target: AddressLike], [boolean], "view">;
    getFunction(nameOrSignature: "isDeployedContract"): TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
    ...
    getFunction(nameOrSignature: "predictAddressBatch"): TypedContractMethod<[
        salts: BytesLike[],
        codeHashes: BytesLike[]
    ], [
        string[]
    ...
    getFunction(nameOrSignature: "removeAuthorizedRecipient"): TypedContractMethod<[recipient: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "setBaseFeeWei"): TypedContractMethod<[newBase: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "setFeeRecipient"): TypedContractMethod<[newRecipient: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "setFeesEnabled"): TypedContractMethod<[enabled: boolean], [void], "nonpayable">;
    getFunction(nameOrSignature: "setIdempotentMode"): TypedContractMethod<[enabled: boolean], [void], "nonpayable">;
    getFunction(nameOrSignature: "setMaxSingleTransfer"): TypedContractMethod<[newMax: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "setTierFee"): TypedContractMethod<[
        tier: BigNumberish,
        fee: BigNumberish
    ], [
        void
    ...
    getFunction(nameOrSignature: "stage"): TypedContractMethod<[
        data: BytesLike
    ], [
        [string, string] & {
            chunk: string;
    ...
    getFunction(nameOrSignature: "stageBatch"): TypedContractMethod<[
        blobs: BytesLike[]
    ], [
        [string[], string[]] & {
            chunks: string[];
    ...
    getFunction(nameOrSignature: "stageMany"): TypedContractMethod<[dataArray: BytesLike[]], [string[]], "payable">;
    getFunction(nameOrSignature: "tierFees"): TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
    getFunction(nameOrSignature: "transferDefaultAdmin"): TypedContractMethod<[newAdmin: AddressLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "userTiers"): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
    getFunction(nameOrSignature: "validateBytecodeSize"): TypedContractMethod<[bytecode: BytesLike], [boolean], "view">;
    ...
    getEvent(key: "AuthorizedRecipientAdded"): TypedContractEvent<AuthorizedRecipientAddedEvent.InputTuple, AuthorizedRecipientAddedEvent.OutputTuple, AuthorizedRecipientAddedEvent.OutputObject>;
    getEvent(key: "AuthorizedRecipientRemoved"): TypedContractEvent<AuthorizedRecipientRemovedEvent.InputTuple, AuthorizedRecipientRemovedEvent.OutputTuple, AuthorizedRecipientRemovedEvent.OutputObject>;
    getEvent(key: "BaseFeeSet"): TypedContractEvent<BaseFeeSetEvent.InputTuple, BaseFeeSetEvent.OutputTuple, BaseFeeSetEvent.OutputObject>;
    getEvent(key: "BatchDeployed"): TypedContractEvent<BatchDeployedEvent.InputTuple, BatchDeployedEvent.OutputTuple, BatchDeployedEvent.OutputObject>;
    getEvent(key: "BatchStaged"): TypedContractEvent<BatchStagedEvent.InputTuple, BatchStagedEvent.OutputTuple, BatchStagedEvent.OutputObject>;
    getEvent(key: "ChunkStaged"): TypedContractEvent<ChunkStagedEvent.InputTuple, ChunkStagedEvent.OutputTuple, ChunkStagedEvent.OutputObject>;
    ...
    getEvent(key: "DefaultAdminTransferred"): TypedContractEvent<DefaultAdminTransferredEvent.InputTuple, DefaultAdminTransferredEvent.OutputTuple, DefaultAdminTransferredEvent.OutputObject>;
    ...
    getEvent(key: "FeeCollectionFailed"): TypedContractEvent<FeeCollectionFailedEvent.InputTuple, FeeCollectionFailedEvent.OutputTuple, FeeCollectionFailedEvent.OutputObject>;
    ...
    getEvent(key: "FeesEnabledSet"): TypedContractEvent<FeesEnabledSetEvent.InputTuple, FeesEnabledSetEvent.OutputTuple, FeesEnabledSetEvent.OutputObject>;
    ...
    getEvent(key: "IdempotentModeSet"): TypedContractEvent<IdempotentModeSetEvent.InputTuple, IdempotentModeSetEvent.OutputTuple, IdempotentModeSetEvent.OutputObject>;
    getEvent(key: "TierFeeSet"): TypedContractEvent<TierFeeSetEvent.InputTuple, TierFeeSetEvent.OutputTuple, TierFeeSetEvent.OutputObject>;
    ...
    filters: {
        "AuthorizedRecipientAdded(address)": TypedContractEvent<AuthorizedRecipientAddedEvent.InputTuple, AuthorizedRecipientAddedEvent.OutputTuple, AuthorizedRecipientAddedEvent.OutputObject>;
        AuthorizedRecipientAdded: TypedContractEvent<AuthorizedRecipientAddedEvent.InputTuple, AuthorizedRecipientAddedEvent.OutputTuple, AuthorizedRecipientAddedEvent.OutputObject>;
        "AuthorizedRecipientRemoved(address)": TypedContractEvent<AuthorizedRecipientRemovedEvent.InputTuple, AuthorizedRecipientRemovedEvent.OutputTuple, AuthorizedRecipientRemovedEvent.OutputObject>;
        AuthorizedRecipientRemoved: TypedContractEvent<AuthorizedRecipientRemovedEvent.InputTuple, AuthorizedRecipientRemovedEvent.OutputTuple, AuthorizedRecipientRemovedEvent.OutputObject>;
        "BaseFeeSet(uint256)": TypedContractEvent<BaseFeeSetEvent.InputTuple, BaseFeeSetEvent.OutputTuple, BaseFeeSetEvent.OutputObject>;
        BaseFeeSet: TypedContractEvent<BaseFeeSetEvent.InputTuple, BaseFeeSetEvent.OutputTuple, BaseFeeSetEvent.OutputObject>;
        "BatchDeployed(address[],bytes32[],address,uint256)": TypedContractEvent<BatchDeployedEvent.InputTuple, BatchDeployedEvent.OutputTuple, BatchDeployedEvent.OutputObject>;
        BatchDeployed: TypedContractEvent<BatchDeployedEvent.InputTuple, BatchDeployedEvent.OutputTuple, BatchDeployedEvent.OutputObject>;
        "BatchStaged(uint256,uint256,bytes32,uint256)": TypedContractEvent<BatchStagedEvent.InputTuple, BatchStagedEvent.OutputTuple, BatchStagedEvent.OutputObject>;
        BatchStaged: TypedContractEvent<BatchStagedEvent.InputTuple, BatchStagedEvent.OutputTuple, BatchStagedEvent.OutputObject>;
        "ChunkStaged(address,bytes32,bytes32,uint256)": TypedContractEvent<ChunkStagedEvent.InputTuple, ChunkStagedEvent.OutputTuple, ChunkStagedEvent.OutputObject>;
        ChunkStaged: TypedContractEvent<ChunkStagedEvent.InputTuple, ChunkStagedEvent.OutputTuple, ChunkStagedEvent.OutputObject>;
        "ContractDeployed(address,bytes32,address,uint256)": TypedContractEvent<ContractDeployedEvent.InputTuple, ContractDeployedEvent.OutputTuple, ContractDeployedEvent.OutputObject>;
        ...
        "DefaultAdminTransferred(address,address)": TypedContractEvent<DefaultAdminTransferredEvent.InputTuple, DefaultAdminTransferredEvent.OutputTuple, DefaultAdminTransferredEvent.OutputObject>;
        DefaultAdminTransferred: TypedContractEvent<DefaultAdminTransferredEvent.InputTuple, DefaultAdminTransferredEvent.OutputTuple, DefaultAdminTransferredEvent.OutputObject>;
        ...
        "FeeCollectionFailed(address,uint256)": TypedContractEvent<FeeCollectionFailedEvent.InputTuple, FeeCollectionFailedEvent.OutputTuple, FeeCollectionFailedEvent.OutputObject>;
        FeeCollectionFailed: TypedContractEvent<FeeCollectionFailedEvent.InputTuple, FeeCollectionFailedEvent.OutputTuple, FeeCollectionFailedEvent.OutputObject>;
        ...
        "FeesEnabledSet(bool)": TypedContractEvent<FeesEnabledSetEvent.InputTuple, FeesEnabledSetEvent.OutputTuple, FeesEnabledSetEvent.OutputObject>;
        FeesEnabledSet: TypedContractEvent<FeesEnabledSetEvent.InputTuple, FeesEnabledSetEvent.OutputTuple, FeesEnabledSetEvent.OutputObject>;
        ...
        "IdempotentModeSet(bool)": TypedContractEvent<IdempotentModeSetEvent.InputTuple, IdempotentModeSetEvent.OutputTuple, IdempotentModeSetEvent.OutputObject>;
        IdempotentModeSet: TypedContractEvent<IdempotentModeSetEvent.InputTuple, IdempotentModeSetEvent.OutputTuple, IdempotentModeSetEvent.OutputObject>;
        "TierFeeSet(uint8,uint256)": TypedContractEvent<TierFeeSetEvent.InputTuple, TierFeeSetEvent.OutputTuple, TierFeeSetEvent.OutputObject>;
        TierFeeSet: TypedContractEvent<TierFeeSetEvent.InputTuple, TierFeeSetEvent.OutputTuple, TierFeeSetEvent.OutputObject>;
        "UserTierSet(address,uint8)": TypedContractEvent<UserTierSetEvent.InputTuple, UserTierSetEvent.OutputTuple, UserTierSetEvent.OutputObject>;
