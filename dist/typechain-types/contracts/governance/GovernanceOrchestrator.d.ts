...
export declare namespace ManifestTypes {
    ...
    type GovernanceProposalStructOutput = [
        proposalId: string,
        proposer: string,
        description: string,
        targetHashes: string[],
...
export interface GovernanceOrchestratorInterface extends Interface {
    getFunction(nameOrSignature: "EMERGENCY_ROLE" | "MAX_VOTING_PERIOD" | "MIN_VOTING_PERIOD" | "PROPOSER_ROLE" | "allProposals" | "castVote" | "checkProposalStatus" | "createProposal" | "executeProposal" | "executedProposals" | "getProposal" | "getProposalCount" | "proposals" | "quorumThreshold" | "totalVotingSupply" | "updateQuorumThreshold" | "updateVotingPower" | "voteSupport" | "votes" | "votingPower"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "GovernanceVoteCast" | "ProposalCreated" | "ProposalExecuted" | "QuorumThresholdUpdated" | "VoteCast" | "VotingPowerUpdated"): EventFragment;
    ...
    encodeFunctionData(functionFragment: "createProposal", values: [BytesLike, string, BytesLike[], BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "updateVotingPower", values: [AddressLike, BigNumberish]): string;
...
export declare namespace ProposalExecutedEvent {
    type InputTuple = [proposalId: BytesLike, success: boolean];
    type OutputTuple = [proposalId: string, success: boolean];
    interface OutputObject {
        proposalId: string;
        success: boolean;
    }
...
export declare namespace QuorumThresholdUpdatedEvent {
    type InputTuple = [
...
export interface GovernanceOrchestrator extends BaseContract {
    ...
    getFunction(nameOrSignature: "allProposals"): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
    ...
    getFunction(nameOrSignature: "checkProposalStatus"): TypedContractMethod<[proposalId: BytesLike], [boolean], "view">;
    ...
    getFunction(nameOrSignature: "executeProposal"): TypedContractMethod<[proposalId: BytesLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "executedProposals"): TypedContractMethod<[arg0: BytesLike], [boolean], "view">;
    ...
    getFunction(nameOrSignature: "updateQuorumThreshold"): TypedContractMethod<[newThreshold: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "updateVotingPower"): TypedContractMethod<[
        account: AddressLike,
        newPower: BigNumberish
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "voteSupport"): TypedContractMethod<[
        arg0: BytesLike,
        arg1: AddressLike
    ], [
        boolean
    ...
    getFunction(nameOrSignature: "votingPower"): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
    ...
    getEvent(key: "QuorumThresholdUpdated"): TypedContractEvent<QuorumThresholdUpdatedEvent.InputTuple, QuorumThresholdUpdatedEvent.OutputTuple, QuorumThresholdUpdatedEvent.OutputObject>;
    ...
    filters: {
        ...
        "ProposalCreated(bytes32,address,string,uint256)": TypedContractEvent<ProposalCreatedEvent.InputTuple, ProposalCreatedEvent.OutputTuple, ProposalCreatedEvent.OutputObject>;
        ...
        "ProposalExecuted(bytes32,bool)": TypedContractEvent<ProposalExecutedEvent.InputTuple, ProposalExecutedEvent.OutputTuple, ProposalExecutedEvent.OutputObject>;
        ...
        "QuorumThresholdUpdated(uint256,uint256)": TypedContractEvent<QuorumThresholdUpdatedEvent.InputTuple, QuorumThresholdUpdatedEvent.OutputTuple, QuorumThresholdUpdatedEvent.OutputObject>;
        QuorumThresholdUpdated: TypedContractEvent<QuorumThresholdUpdatedEvent.InputTuple, QuorumThresholdUpdatedEvent.OutputTuple, QuorumThresholdUpdatedEvent.OutputObject>;
        "VoteCast(bytes32,address,bool,uint256)": TypedContractEvent<VoteCastEvent.InputTuple, VoteCastEvent.OutputTuple, VoteCastEvent.OutputObject>;
