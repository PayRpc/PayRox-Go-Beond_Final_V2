...
export interface PayRoxProxyRouterInterface extends Interface {
    getFunction(nameOrSignature: "MAX_BATCH_SIZE" | "batchCallSameFunction" | "batchExecute" | "dispatcher" | "dispatcherCodehash" | "freeze" | "frozen" | "getActiveManifestRoot" | "getRoute" | "initializeProxyRouter" | "isDispatcherFrozen" | "isForbidden" | "owner" | "paused" | "renounceOwnership" | "setDispatcher" | "setDispatcherCodehash" | "setForbiddenSelectors" | "setPaused" | "setStrictCodehash" | "strictCodehash" | "transferOwnership"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "BatchExecuted" | "DispatcherCodehashSet" | "DispatcherUpdated" | "Frozen" | "OwnershipTransferred" | "PausedSet" | "PayRoxProxyRouterInitialized" | "SelectorsForbidden" | "StrictCodehashSet"): EventFragment;
    encodeFunctionData(functionFragment: "MAX_BATCH_SIZE", values?: undefined): string;
    encodeFunctionData(functionFragment: "batchCallSameFunction", values: [BytesLike, BytesLike[]]): string;
    ...
    encodeFunctionData(functionFragment: "initializeProxyRouter", values: [AddressLike, AddressLike, BytesLike, boolean]): string;
    ...
    encodeFunctionData(functionFragment: "setForbiddenSelectors", values: [BytesLike[], boolean]): string;
...
export declare namespace DispatcherCodehashSetEvent {
    type InputTuple = [oldCodehash: BytesLike, newCodehash: BytesLike];
    type OutputTuple = [oldCodehash: string, newCodehash: string];
    interface OutputObject {
        oldCodehash: string;
        newCodehash: string;
    }
...
export declare namespace DispatcherUpdatedEvent {
    type InputTuple = [
...
export declare namespace PayRoxProxyRouterInitializedEvent {
    type InputTuple = [
        owner: AddressLike,
...
export declare namespace SelectorsForbiddenEvent {
    type InputTuple = [selectors: BytesLike[], forbidden: boolean];
    type OutputTuple = [selectors: string[], forbidden: boolean];
    interface OutputObject {
        selectors: string[];
        forbidden: boolean;
    }
...
export declare namespace StrictCodehashSetEvent {
...
export interface PayRoxProxyRouter extends BaseContract {
    ...
    getFunction(nameOrSignature: "batchCallSameFunction"): TypedContractMethod<[
        selector: BytesLike,
        datas: BytesLike[]
    ], [
        string[]
    ], "nonpayable">;
    getFunction(nameOrSignature: "batchExecute"): TypedContractMethod<[calls: BatchCallStruct[]], [string[]], "nonpayable">;
    ...
    getFunction(nameOrSignature: "initializeProxyRouter"): TypedContractMethod<[
        owner_: AddressLike,
        dispatcher_: AddressLike,
        expectedCodehash: BytesLike,
        strictCodehash_: boolean
    ...
    getFunction(nameOrSignature: "isForbidden"): TypedContractMethod<[selector: BytesLike], [boolean], "view">;
    ...
    getFunction(nameOrSignature: "setDispatcherCodehash"): TypedContractMethod<[expected: BytesLike], [void], "nonpayable">;
    getFunction(nameOrSignature: "setForbiddenSelectors"): TypedContractMethod<[
        selectors: BytesLike[],
        forbidden: boolean
    ], [
        void
    ], "nonpayable">;
    getFunction(nameOrSignature: "setPaused"): TypedContractMethod<[paused_: boolean], [void], "nonpayable">;
    getFunction(nameOrSignature: "setStrictCodehash"): TypedContractMethod<[enabled: boolean], [void], "nonpayable">;
    ...
    getEvent(key: "DispatcherCodehashSet"): TypedContractEvent<DispatcherCodehashSetEvent.InputTuple, DispatcherCodehashSetEvent.OutputTuple, DispatcherCodehashSetEvent.OutputObject>;
    getEvent(key: "DispatcherUpdated"): TypedContractEvent<DispatcherUpdatedEvent.InputTuple, DispatcherUpdatedEvent.OutputTuple, DispatcherUpdatedEvent.OutputObject>;
    ...
    getEvent(key: "PayRoxProxyRouterInitialized"): TypedContractEvent<PayRoxProxyRouterInitializedEvent.InputTuple, PayRoxProxyRouterInitializedEvent.OutputTuple, PayRoxProxyRouterInitializedEvent.OutputObject>;
    getEvent(key: "SelectorsForbidden"): TypedContractEvent<SelectorsForbiddenEvent.InputTuple, SelectorsForbiddenEvent.OutputTuple, SelectorsForbiddenEvent.OutputObject>;
    getEvent(key: "StrictCodehashSet"): TypedContractEvent<StrictCodehashSetEvent.InputTuple, StrictCodehashSetEvent.OutputTuple, StrictCodehashSetEvent.OutputObject>;
    filters: {
        "BatchExecuted(uint256,uint256,uint256)": TypedContractEvent<BatchExecutedEvent.InputTuple, BatchExecutedEvent.OutputTuple, BatchExecutedEvent.OutputObject>;
        ...
        "DispatcherCodehashSet(bytes32,bytes32)": TypedContractEvent<DispatcherCodehashSetEvent.InputTuple, DispatcherCodehashSetEvent.OutputTuple, DispatcherCodehashSetEvent.OutputObject>;
        DispatcherCodehashSet: TypedContractEvent<DispatcherCodehashSetEvent.InputTuple, DispatcherCodehashSetEvent.OutputTuple, DispatcherCodehashSetEvent.OutputObject>;
        "DispatcherUpdated(address,address,bytes32)": TypedContractEvent<DispatcherUpdatedEvent.InputTuple, DispatcherUpdatedEvent.OutputTuple, DispatcherUpdatedEvent.OutputObject>;
        DispatcherUpdated: TypedContractEvent<DispatcherUpdatedEvent.InputTuple, DispatcherUpdatedEvent.OutputTuple, DispatcherUpdatedEvent.OutputObject>;
        ...
        "PausedSet(bool)": TypedContractEvent<PausedSetEvent.InputTuple, PausedSetEvent.OutputTuple, PausedSetEvent.OutputObject>;
        PausedSet: TypedContractEvent<PausedSetEvent.InputTuple, PausedSetEvent.OutputTuple, PausedSetEvent.OutputObject>;
        "PayRoxProxyRouterInitialized(address,address,bytes32,bool)": TypedContractEvent<PayRoxProxyRouterInitializedEvent.InputTuple, PayRoxProxyRouterInitializedEvent.OutputTuple, PayRoxProxyRouterInitializedEvent.OutputObject>;
        PayRoxProxyRouterInitialized: TypedContractEvent<PayRoxProxyRouterInitializedEvent.InputTuple, PayRoxProxyRouterInitializedEvent.OutputTuple, PayRoxProxyRouterInitializedEvent.OutputObject>;
        "SelectorsForbidden(bytes4[],bool)": TypedContractEvent<SelectorsForbiddenEvent.InputTuple, SelectorsForbiddenEvent.OutputTuple, SelectorsForbiddenEvent.OutputObject>;
        SelectorsForbidden: TypedContractEvent<SelectorsForbiddenEvent.InputTuple, SelectorsForbiddenEvent.OutputTuple, SelectorsForbiddenEvent.OutputObject>;
        "StrictCodehashSet(bool)": TypedContractEvent<StrictCodehashSetEvent.InputTuple, StrictCodehashSetEvent.OutputTuple, StrictCodehashSetEvent.OutputObject>;
        StrictCodehashSet: TypedContractEvent<StrictCodehashSetEvent.InputTuple, StrictCodehashSetEvent.OutputTuple, StrictCodehashSetEvent.OutputObject>;
    };
}
