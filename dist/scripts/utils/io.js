...
async function readJsonFileAsync(filePath, options = {}) {
  try {
    ...
    throw new FileOperationError(
      `Failed to read JSON file asynchronously: ${error instanceof Error ? error.message : 'Unknown error'}`,
      'read_json_async',
      filePath,
      error instanceof Error ? error : undefined,
    );
...
async function writeJsonFileAsync(filePath, data, options = {}) {
  try {
    ...
    throw new FileOperationError(
      `Failed to write JSON file asynchronously: ${error instanceof Error ? error.message : 'Unknown error'}`,
      'write_json_async',
      filePath,
      error instanceof Error ? error : undefined,
    );
...
async function ensureDirectoryExistsAsync(dirPath, options = {}) {
  try {
    ...
    throw new FileOperationError(
      `Failed to create directory asynchronously: ${error instanceof Error ? error.message : 'Unknown error'}`,
...
async function getFileMetadataAsync(filePath, options = {}) {
  try {
    ...
    throw new FileOperationError(
      `Failed to get file metadata asynchronously: ${error instanceof Error ? error.message : 'Unknown error'}`,
      'get_metadata_async',
      filePath,
      error instanceof Error ? error : undefined,
    );
...
function getDirectorySize(dirPath, options = {}) {
  try {
    ...
    throw new FileOperationError(
      `Failed to calculate directory size: ${error instanceof Error ? error.message : 'Unknown error'}`,
      'directory_size',
      dirPath,
      error instanceof Error ? error : undefined,
    );
