...
export declare function linkBytecode(bytecode: string, linkReferences: any, libraryAddresses?: LibraryAddressMap): string;
/**
 ...
 */
export declare function generateManifestLeaves(manifest: any, artifacts: any, factoryAddress: string, opts?: {
