 ...
 */
export declare function validateFileSize(
  size: number,
  maxSize?: number,
 ...
 */
export declare function readJsonFileAsync<T = any>(
  filePath: string,
 ...
 */
export declare function writeJsonFile<T = any>(
  filePath: string,
  data: T,
  options?: FileOperationOptions & {
    indent?: number;
 ...
 * @param options File operation options
 */
export declare function writeJsonFileAsync<T = any>(
  filePath: string,
  data: T,
  options?: FileOperationOptions & {
    indent?: number;
 ...
 */
export declare function saveDeploymentArtifact(
 ...
 */
export declare function ensureDirectoryExists(
  dirPath: string,
  options?: {
    mode?: string | number;
    validatePath?: boolean;
 ...
 * @param options Directory creation options
 */
export declare function ensureDirectoryExistsAsync(
  dirPath: string,
  options?: {
    mode?: string | number;
    validatePath?: boolean;
 ...
 */
export declare function getFileMetadata(
  filePath: string,
  options?: {
    validatePath?: boolean;
 ...
 */
export declare function getFileMetadataAsync(
  filePath: string,
  options?: {
    validatePath?: boolean;
    includeChecksum?: boolean;
 ...
 */
export declare function moveFile(
  sourcePath: string,
  destinationPath: string,
  options?: {
    validatePaths?: boolean;
 ...
 */
export declare function getDirectorySize(
  dirPath: string,
  options?: {
    validatePath?: boolean;
    maxDepth?: number;
 ...
 */
export declare function cleanDirectory(
  dirPath: string,
  options?: {
    preserveDir?: boolean;
    validatePath?: boolean;
