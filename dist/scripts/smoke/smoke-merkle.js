...
async function main() {
    ...
    assert_1.default.strictEqual(rootLeft.toLowerCase(), expectedRootLeft.toLowerCase(), 'processOrderedProof failed for left sibling case');
    assert_1.default.strictEqual((0, ordered_merkle_1.verifyOrderedProof)(leaf0, proof, positionsRight, rootLeft), true, 'verifyOrderedProof failed for left sibling case');
    ...
    assert_1.default.strictEqual((0, ordered_merkle_1.verifyOrderedProof)(leaf0, proof, positionsLeft, rootRight), true, 'verifyOrderedProof failed for right sibling case');
