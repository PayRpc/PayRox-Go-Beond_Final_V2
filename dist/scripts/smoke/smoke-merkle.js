...
async function main() {
    ...
    assert.strictEqual(rootLeft.toLowerCase(), expectedRootLeft.toLowerCase(), 'processOrderedProof failed for left sibling case');
    assert.strictEqual(verifyOrderedProof(leaf0, proof, positionsRight, rootLeft), true, 'verifyOrderedProof failed for left sibling case');
    ...
    assert.strictEqual(verifyOrderedProof(leaf0, proof, positionsLeft, rootRight), true, 'verifyOrderedProof failed for right sibling case');
